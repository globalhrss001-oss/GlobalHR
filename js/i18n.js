...
(function (window, document) {
  ...
  var STRINGS = {
    ...
    "meta.servicesTitle": { en: "Services | Global HR", ja: "サービス | Global HR" },
    "meta.servicesDesc": {
      en: "Recruitment services for job seekers and employers across Asia-Pacific & beyond.",
      ja: "求職者と採用企業向けの人材紹介サービス（アジア太平洋地域およびその先）。",
    },
    "meta.trainingTitle": {
    ...
    "nav.training": { en: "Training & Cert.", ja: "研修・資格" },
    ...
    "nav.values": { en: "Our values", ja: "理念" },
    ...
    "nav.arrival": { en: "Arrival service", ja: "到着サポート" },
    ...
    "footer.myanmar": { en: "Myanmar: +95 1 356 0017 · +95 1 356 0018", ja: "ミャンマー: +95 1 356 0017 · +95 1 356 0018" },
    "footer.singapore": {
    ...
    "home.exploreServices": { en: "Explore all services →", ja: "すべてのサービスを見る →" },
    ...
    "about.story1": {
      en: "Global HR has supported recruitment across Asia-Pacific & beyond <strong>since 2001</strong>. We connect talent with opportunities in China, India, and the wider region—and help employers hire with confidence, combining local market knowledge with structured, compliant processes.",
      ja: "Global HRは<strong>2001年</strong>より、アジア太平洋地域およびその先で人材紹介を行っています。中国、インド、およびその周辺地域で人材と機会をつなぎ、現地の市場知識と、法令を守った手続きにより、企業が安心して採用できるよう支援します。",
    },
    "about.story2": {
    ...
    "about.valuesTitle": { en: "Our values", ja: "理念" },
    "about.val1Title": { en: "Integrity", ja: "誠実" },
    "about.val1Text": {
      en: "Transparent processes and honest guidance for candidates and clients.",
      ja: "求職者とお客様の双方に、透明な手続きと誠実な案内を行います。",
    },
    "about.val2Title": { en: "Speed with care", ja: "迅速かつ丁寧に" },
    "about.val2Text": {
      en: "We move quickly, without cutting corners on screening or compliance.",
      ja: "選考と法令順守を省略せず、迅速に進めます。",
    },
    "about.val3Title": { en: "Partnership", ja: "パートナーシップ" },
    "about.val3Text": {
      en: "We work alongside employers and job seekers as a long-term ally.",
      ja: "採用企業と求職者の長期的なパートナーとして伴走します。",
    },
    "about.val4Title": { en: "Quality matches", ja: "適材適所" },
    "about.val4Text": {
      en: "We prioritise fit: skills, culture, and career direction—not volume alone.",
      ja: "件数だけでなく、技能・社風・キャリアの適合を重視します。",
    },
    ...
    "about.consultants": { en: "Consultants", ja: "コンサルタント" },
    "about.consultantsSoon": { en: "Photo and bio to follow", ja: "写真・経歴は後日掲載" },
    "about.cta": { en: "Ready to work with us?", ja: "ご一緒に進めませんか？" },
    "about.contact": { en: "Contact", ja: "お問い合わせ" },

    "services.heroTitle": { en: "Services", ja: "サービス" },
    "services.heroLead": {
      en: "Tailored recruitment support for job seekers and employers across Asia-Pacific & beyond, including China and India.",
      ja: "求職者と採用企業それぞれに合わせた人材紹介支援（アジア太平洋地域およびその先。中国・インドを含みます）。",
    },
    ...
    "services.arrivalTitle": { en: "Arrival service", ja: "到着サポート" },
    "services.arrivalLead": {
      en: "On-ground support from airport arrival through mobilisation to worksites across Asia-Pacific & beyond.",
      ja: "空港到着から現場への赴任まで、現地でのサポートを行います。",
    },
